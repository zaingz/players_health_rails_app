class ReadingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reading.save
        format.html { redirect_to player_readings_path, notice: 'Reading was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @reading.update(reading_params)
        format.html { redirect_to player_readings_path, notice: 'Reading was successfully updated.' }
